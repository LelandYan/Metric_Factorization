...
def split_data(user_item_matrix,split_ratio=(3,1,1)):
    ...
    unique_test_users = unique_users_validation = set(np.arange(users))
    ...
    return train.todok(),neg_user_item_matrix,test.todok(),validation.todok(),test_user_item_matrix, validation_user_item_matrix,set(unique_test_users), set(unique_users_validation)
